...
print('output 1 is the sum: ' + str(output_1))
print()
...
print('output 1 is the sum: ' + str(output_2))
print()
...
user_var = input('please enter an interger.\n')
...
#    Review for loops in your textbook.
...
for i in range(int(user_var)):
      print('The next number is ' + str(random.randint(0,9)))



# Tell me about yourself. Complet the following snippet to include
# information about yourself.

print('''
A Litte About Me: 21 yrs. old and have been going to augusta since last spring.

1. My Name: Graham Payne

2. Career Goals: Security Consultant

3. Major/Minor/Certificate Goal: Bachelors in Cyber Security

4. Class Standing: Don't know?

5. Python Programming Experience: Personal Projects
